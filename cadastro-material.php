 ...
 <?php while($row = mysqli_fetch_assoc($result)): ?> 
  ...
  <tr>
    ...
    <td class="actions text-right">
      <a href="view.php?id=<?php echo $row['id']; ?>"button type="button" class="btn"><i class="fa fa-eye"></i> Visualizar</a>
      <a href="edit.php?id=<?php echo $row['id']; ?>" button type="button" class="btn "><i class="fa fa-pencil"></i> Editar</a>
      <a href="#" button type="button" class="btn " data-toggle="modal" data-target="#delete-modal" data-customer="<?php echo $row['id']; ?>">
