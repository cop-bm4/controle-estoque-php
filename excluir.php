...
<div class="container">
  ...
  <a href="http://bm4cop-org.umbler.net/mastercadastro-material.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Voltar</a>
</div>
...
$conn->close();
header('location:http://bm4cop-org.umbler.net/mastercadastro-material.php');
}
