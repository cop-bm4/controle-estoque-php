...
<div class="row">
    ...
    <div class="col-sm-10 text-right h2">
        <a class="btn btn-primary" href="http://copbm4-com-br.umbler.net/cadastronovo.php"><i class="fa fa-plus"></i> <span class="glyphicon glyphicon-plus"> </span> Novo Material</a>
