...
<?php
$sql = "SELECT id, ubm, prefixo, placa, renavam, situacao, ocorrencia, nome, rg, defeito, reg_date, cargo,observacoes, chassi, modelo, origem, ano_fab FROM materialoperacional where id=$id ";
...
<div class="container">
  <div class="jumbotron">
  <h2>Visualizaçâo Detalhada da VTR</h2>    
    <br>
...
<div class="row">
  ...
  <a href="http://bm4cop-org.umbler.net/cadastro-vtrs.php"  button type="button" class="btn btn-default btn-lg"  class="">Voltar</a>
 </div>
