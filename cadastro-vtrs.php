...
<?php
$sql = "SELECT id, ubm, prefixo, placa, renavam, chassi, modelo, origem, ano_fab, licenciamento, reg_date,situacao FROM materialoperacional where ubm='$ub' and login='login' ";
