...
<option data-tokens= "ABAFADOR INCÊNDIO" value="ABAFADOR INCÊNDIO" >ABAFADOR INCÊNDIO</option>
...
<option data-tokens= "ALICATE  DE PRESSÃO" value="ALICATE  DE PRESSÃO" >ALICATE  DE PRESSÃO</option>
...
<option data-tokens= "APARELHO EXTINTOR INCÊNDIO" value= "APARELHO EXTINTOR INCÊNDIO ">APARELHO EXTINTOR INCÊNDIO</option>
...
<option data-tokens= "BINÓCULO" value="BINÓCULO" >BINÓCULO</option>
<option data-tokens= "BOTA DE INCÊNDIO" value="BOTA DE INCÊNDIO" >BOTA DE INCÊNDIO</option>
...
<option data-tokens= "BOMBAPORTÁTIL" value="BOMBAPORTÁTIL" >BOMBAPORTÁTIL</option>
...
<option data-tokens= "BOTE INFLÁVEL" value="BOTE INFLÁVEL" >BOTE INFLÁVEL</option>
<option data-tokens= "CAIXA TÉRMICA" value="CAIXA TÉRMICA" >CAIXA TÉRMICA</option>
<option data-tokens= "CABO DE AÇO" value="CABO DE AÇO" >CABO DE AÇO</option>
...
<option data-tokens= "CHAVE DE MUNHÃO" value="CHAVE DE MUNHÃO" >CHAVE DE MUNHÃO</option>
...
<option data-tokens= "CONE DE SINALIZAÇÃO" value="CONE DE SINALIZAÇÃO" >CONE DE SINALIZAÇÃO</option>
...
<option data-tokens= "CONJUNTO DE APROXIMAÇÃO (CALÇA / CAPA)" value="CONJUNTO DE APROXIMAÇÃO (CALÇA / CAPA)" >CONJUNTO DE APROXIMAÇÃO (CALÇA / CAPA)</option>
...
<option data-tokens= "CAPACETE INCÊNDIO" value="CAPACETE INCÊNDIO" >CAPACETE INCÊNDIO</option>
...
<option data-tokens= "CADEIRÃO  PRAIA" value="CADEIRÃO  PRAIA" >CADEIRÃO  PRAIA</option>
<option data-tokens= "CILINDRO PA" value="CILINDRO PA" >CILINDRO PA</option>
<option data-tokens= "COLETE DE SINALIZAÇÃO" value="COLETE DE SINALIZAÇÃO" >COLETE DE SINALIZAÇÃO</option>
...
<option data-tokens= "DIVISÃO DE DUAS SAÍDAS" value="DIVISÃO DE DUAS SAÍDAS" >DIVISÃO DE DUAS SAÍDAS</option>
<option data-tokens= "DESENCARCERADOR A ÓLEO" value="DESENCARCERADOR A ÓLEO" >DESENCARCERADOR A ÓLEO</option>
<option data-tokens= "DESENCARCERADOR ELÉTRICO" value="DESENCARCERADOR ELÉTRICO" >DESENCARCERADOR ELÉTRICO</option>
...
<option data-tokens= "ESCADA EM ALUMÍNIO" value="ESCADA EM ALUMÍNIO" >ESCADA EM ALUMÍNIO</option>
...
<option data-tokens= "ESGUICHO CANHÃO" value="ESGUICHO CANHÃO" >ESGUICHO CANHÃO</option>
...
<option data-tokens= "FACÃO OUTERÇADO" value="FACÃO OUTERÇADO" >FACÃO OUTERÇADO</option>
...
<option data-tokens= "GARATÉIA" value="GARATÉIA" >GARATÉIA</option>
...
<option data-tokens= "HOLOFOTE COM TRIPÉ" value="HOLOFOTE COM TRIPÉ" >HOLOFOTE COM TRIPÉ</option>
<option data-tokens= "HOSPITAL CAMPANHA" value="HOSPITAL CAMPANHA" >HOSPITAL CAMPANHA</option>
<option data-tokens= "LANTERNA RECARREGÁVEL" value="LANTERNA RECARREGÁVEL" >LANTERNA RECARREGÁVEL</option>
<option data-tokens= "LINGA DE AÇO" value="LINGA DE AÇO" >LINGA DE AÇO</option>
<option data-tokens= "LUVA ALTA TENSÃO" value="LUVA ALTA TENSÃO" >LUVA ALTA TENSÃO</option>
...
<option data-tokens= "MÁSCARA CONTRA GASES" value="MÁSCARA CONTRA GASES" >MÁSCARA CONTRA GASES</option>
<option data-tokens= "MÁSCARA PANORÂMICA" value="MÁSCARA PANORÂMICA" >MÁSCARA PANORÂMICA</option>
<option data-tokens= "MACACO MECÂNICO" value="MACACO MECÂNICO" >MACACO MECÂNICO</option>
...
<option data-tokens= "MICRO RETÍFICA" value="MICRO RETÍFICA" >MICRO RETÍFICA</option>
<option data-tokens= "MOLA MOSQUETÃO" value="MOLA MOSQUETÃO" >MOLA MOSQUETÃO</option>
...
<option data-tokens= "MOTO BOMBAELÉTRICA" value="MOTO BOMBAELÉTRICA" >MOTO BOMBAELÉTRICA</option>
...
<option data-tokens= "OCULOS PROTEÇÃO" value="OCULOS PROTEÇÃO" >OCULOS PROTEÇÃO</option>
<option data-tokens= "OXÍMETRO DE PULSO" value="OXÍMETRO DE PULSO" >OXÍMETRO DE PULSO</option>
<option data-tokens= "PINO PÁRA CHOQUE" value="PINO PÁRA CHOQUE" >PINO PÁRA CHOQUE</option>
<option data-tokens= "PÉ DE CABRA" value="PÉ DE CABRA" >PÉ DE CABRA</option>
<option data-tokens= "PÁ DE BICO" value="PÁ DE BICO" >PÁ DE BICO</option>
<option data-tokens= "PÁ QUADRADA" value="PÁ QUADRADA" >PÁ QUADRADA</option>
...
<option data-tokens= "RÁDIO HT ANALÓGICO" value="RÁDIO HT ANALÓGICO" >RÁDIO HT ANALÓGICO</option>
<option data-tokens= "RÁDIO HT DIGITAL" value="RÁDIO HT DIGITAL" >RÁDIO HT DIGITAL</option>
<option data-tokens= "RÁDIO FIXO" value="RÁDIO FIXO" >RÁDIO FIXO</option>
<option data-tokens= "RÁDIO VTR" value="RÁDIO VTR" >RÁDIO VTR</option>
