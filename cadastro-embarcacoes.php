...
?>
<title>Controle de EMBARCAÇÕES </title>
...
<?php
$sql = "SELECT id, ubm, embarcacao, casco, motor, reg_date,situacao, material FROM materialoperacional where ubm='$ub' and login='login' and material='' and embarcacao!='' ";
 ...
 <?php while($row = mysqli_fetch_assoc($result)): ?> 
  ...
  <tr>
    ...
    <td class="actions text-right">
      <a href="http://bm4cop-org.umbler.net/viewembarcacoes.php?id=<?php echo $row['id']; ?>"button type="button" class="btn btn-default"><i class="fa fa-eye"></i> Visualizar</a>
